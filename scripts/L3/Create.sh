...
if ! [ -d "/home/corey/rLab-eos/configs/L3" ]; then mkdir /home/corey/rLab-eos/configs/L3; fi
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/spine1" ]; then mkdir /home/corey/rLab-eos/configs/L3/spine1; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3spine1" > /home/corey/rLab-eos/configs/L3/spine1/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c0:c6:06" >> /home/corey/rLab-eos/configs/L3/spine1/ceos-config
...
sudo brctl addif br0 l3spine1-mgmt
sudo ip link set l3spine1-eth0 netns l3spine1 name eth0 up
sudo ip link set l3spine1-mgmt up
sleep 1
docker run -d --name=l3spine1 --log-opt max-size=1m --net=container:l3spine1-net --ip 10.0.3.27 --privileged -v /home/corey/rLab-eos/configs/L3/spine1:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/spine2" ]; then mkdir /home/corey/rLab-eos/configs/L3/spine2; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3spine2" > /home/corey/rLab-eos/configs/L3/spine2/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c1:c6:07" >> /home/corey/rLab-eos/configs/L3/spine2/ceos-config
...
sudo brctl addif br0 l3spine2-mgmt
sudo ip link set l3spine2-eth0 netns l3spine2 name eth0 up
sudo ip link set l3spine2-mgmt up
sleep 1
docker run -d --name=l3spine2 --log-opt max-size=1m --net=container:l3spine2-net --ip 10.0.3.28 --privileged -v /home/corey/rLab-eos/configs/L3/spine2:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/leaf11" ]; then mkdir /home/corey/rLab-eos/configs/L3/leaf11; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3leaf11" > /home/corey/rLab-eos/configs/L3/leaf11/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c2:c6:08" >> /home/corey/rLab-eos/configs/L3/leaf11/ceos-config
...
sudo brctl addif br0 l3leaf11-mgmt
sudo ip link set l3leaf11-eth0 netns l3leaf11 name eth0 up
sudo ip link set l3leaf11-mgmt up
sleep 1
docker run -d --name=l3leaf11 --log-opt max-size=1m --net=container:l3leaf11-net --ip 10.0.3.29 --privileged -v /home/corey/rLab-eos/configs/L3/leaf11:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/leaf12" ]; then mkdir /home/corey/rLab-eos/configs/L3/leaf12; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3leaf12" > /home/corey/rLab-eos/configs/L3/leaf12/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c3:c6:09" >> /home/corey/rLab-eos/configs/L3/leaf12/ceos-config
...
sudo brctl addif br0 l3leaf12-mgmt
sudo ip link set l3leaf12-eth0 netns l3leaf12 name eth0 up
sudo ip link set l3leaf12-mgmt up
sleep 1
docker run -d --name=l3leaf12 --log-opt max-size=1m --net=container:l3leaf12-net --ip 10.0.3.30 --privileged -v /home/corey/rLab-eos/configs/L3/leaf12:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/leaf21" ]; then mkdir /home/corey/rLab-eos/configs/L3/leaf21; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3leaf21" > /home/corey/rLab-eos/configs/L3/leaf21/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c4:c6:0a" >> /home/corey/rLab-eos/configs/L3/leaf21/ceos-config
...
sudo brctl addif br0 l3leaf21-mgmt
sudo ip link set l3leaf21-eth0 netns l3leaf21 name eth0 up
sudo ip link set l3leaf21-mgmt up
sleep 1
docker run -d --name=l3leaf21 --log-opt max-size=1m --net=container:l3leaf21-net --ip 10.0.3.31 --privileged -v /home/corey/rLab-eos/configs/L3/leaf21:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/leaf22" ]; then mkdir /home/corey/rLab-eos/configs/L3/leaf22; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3leaf22" > /home/corey/rLab-eos/configs/L3/leaf22/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c5:c6:0b" >> /home/corey/rLab-eos/configs/L3/leaf22/ceos-config
...
sudo brctl addif br0 l3leaf22-mgmt
sudo ip link set l3leaf22-eth0 netns l3leaf22 name eth0 up
sudo ip link set l3leaf22-mgmt up
sleep 1
docker run -d --name=l3leaf22 --log-opt max-size=1m --net=container:l3leaf22-net --ip 10.0.3.32 --privileged -v /home/corey/rLab-eos/configs/L3/leaf22:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/leaf31" ]; then mkdir /home/corey/rLab-eos/configs/L3/leaf31; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3leaf31" > /home/corey/rLab-eos/configs/L3/leaf31/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c6:c6:0c" >> /home/corey/rLab-eos/configs/L3/leaf31/ceos-config
...
sudo brctl addif br0 l3leaf31-mgmt
sudo ip link set l3leaf31-eth0 netns l3leaf31 name eth0 up
sudo ip link set l3leaf31-mgmt up
sleep 1
docker run -d --name=l3leaf31 --log-opt max-size=1m --net=container:l3leaf31-net --ip 10.0.3.33 --privileged -v /home/corey/rLab-eos/configs/L3/leaf31:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/leaf32" ]; then mkdir /home/corey/rLab-eos/configs/L3/leaf32; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3leaf32" > /home/corey/rLab-eos/configs/L3/leaf32/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c7:c6:0d" >> /home/corey/rLab-eos/configs/L3/leaf32/ceos-config
...
sudo brctl addif br0 l3leaf32-mgmt
sudo ip link set l3leaf32-eth0 netns l3leaf32 name eth0 up
sudo ip link set l3leaf32-mgmt up
sleep 1
docker run -d --name=l3leaf32 --log-opt max-size=1m --net=container:l3leaf32-net --ip 10.0.3.34 --privileged -v /home/corey/rLab-eos/configs/L3/leaf32:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/brdr1" ]; then mkdir /home/corey/rLab-eos/configs/L3/brdr1; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3brdr1" > /home/corey/rLab-eos/configs/L3/brdr1/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c8:c6:0e" >> /home/corey/rLab-eos/configs/L3/brdr1/ceos-config
...
sudo brctl addif br0 l3brdr1-mgmt
sudo ip link set l3brdr1-eth0 netns l3brdr1 name eth0 up
sudo ip link set l3brdr1-mgmt up
sleep 1
docker run -d --name=l3brdr1 --log-opt max-size=1m --net=container:l3brdr1-net --ip 10.0.3.35 --privileged -v /home/corey/rLab-eos/configs/L3/brdr1:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
# Checking for configs directory for each cEOS node
if ! [ -d "/home/corey/rLab-eos/configs/L3/brdr2" ]; then mkdir /home/corey/rLab-eos/configs/L3/brdr2; fi
# Creating the ceos-config file.
echo "SERIALNUMBER=l3brdr2" > /home/corey/rLab-eos/configs/L3/brdr2/ceos-config
echo "SYSTEMMACADDR=00:1c:73:c9:c6:0f" >> /home/corey/rLab-eos/configs/L3/brdr2/ceos-config
...
sudo brctl addif br0 l3brdr2-mgmt
sudo ip link set l3brdr2-eth0 netns l3brdr2 name eth0 up
sudo ip link set l3brdr2-mgmt up
sleep 1
docker run -d --name=l3brdr2 --log-opt max-size=1m --net=container:l3brdr2-net --ip 10.0.3.36 --privileged -v /home/corey/rLab-eos/configs/L3/brdr2:/mnt/flash:Z -e INTFTYPE=et -e MGMT_INTF=eth0 -e ETBA=1 -e SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 -e CEOS=1 -e EOS_PLATFORM=ceoslab -e container=docker -i -t ceosimage:4.26.1F /sbin/init systemd.setenv=INTFTYPE=et systemd.setenv=MGMT_INTF=eth0 systemd.setenv=ETBA=1 systemd.setenv=SKIP_ZEROTOUCH_BARRIER_IN_SYSDBINIT=1 systemd.setenv=CEOS=1 systemd.setenv=EOS_PLATFORM=ceoslab systemd.setenv=container=docker
...
sleep 1
docker run -d --name=l3host11 --privileged --log-opt max-size=1m --net=container:l3host11-net -e HOSTNAME=l3host11 -e HOST_IP=192.168.12.11 -e HOST_MASK=255.255.255.0 -e HOST_GW=192.168.12.1 chost:0.5 ipnet
...
sleep 1
docker run -d --name=l3host12 --privileged --log-opt max-size=1m --net=container:l3host12-net -e HOSTNAME=l3host12 -e HOST_IP=192.168.13.11 -e HOST_MASK=255.255.255.0 -e HOST_GW=192.168.13.1 chost:0.5 ipnet
...
sleep 1
docker run -d --name=l3host21 --privileged --log-opt max-size=1m --net=container:l3host21-net -e HOSTNAME=l3host21 -e HOST_IP=192.168.12.21 -e HOST_MASK=255.255.255.0 -e HOST_GW=192.168.12.1 chost:0.5 ipnet
...
sleep 1
docker run -d --name=l3host22 --privileged --log-opt max-size=1m --net=container:l3host22-net -e HOSTNAME=l3host22 -e HOST_IP=192.168.13.21 -e HOST_MASK=255.255.255.0 -e HOST_GW=192.168.13.1 chost:0.5 ipnet
...
sleep 1
docker run -d --name=l3host31 --privileged --log-opt max-size=1m --net=container:l3host31-net -e HOSTNAME=l3host31 -e HOST_IP=192.168.12.31 -e HOST_MASK=255.255.255.0 -e HOST_GW=192.168.12.1 chost:0.5 ipnet
...
sleep 1
docker run -d --name=l3host32 --privileged --log-opt max-size=1m --net=container:l3host32-net -e HOSTNAME=l3host32 -e HOST_IP=192.168.13.31 -e HOST_MASK=255.255.255.0 -e HOST_GW=192.168.13.1 chost:0.5 ipnet
